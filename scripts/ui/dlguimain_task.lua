...
local function AdjustTaskListItemPosition()
    ...
    UIListItem_FamilyTask.gameObject.transform.localPosition = Vector3(pos.x, pos.y - uiWidget_MainlineListItem.height - uiWidget_BranchListItem.height - 1.5* itemDistance, pos.z)
end
