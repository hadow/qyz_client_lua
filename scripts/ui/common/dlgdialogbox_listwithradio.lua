...
local DefiniteDlg = {
    [DlgType.TournamentGuess] = "ui.activity.tournament.dlgtournamenguess",
}
...
local function show(params)
    -- printyellow("[dlgdialogbox_listwithradio:show] params:", params)
    type = params.type
    subDlg = require(DefiniteDlg[type])
    subDlg.show(params)
    --local go = GameObject.Find("dlgdialogbox_listwithradio")
