...
local DefiniteDlg = {
    [DlgType.TournamentVS] = "ui.activity.tournament.dlgtournamentvs",
}
...
local function DisplayGroupByType(type)
    fields.UIGroup_RadioButton.gameObject:SetActive(type==DlgType.TournamentVS)
    fields.UIGroup_Log.gameObject:SetActive(type==DlgType.TournamentVS)
end
...
local function show(params)
    ...
    subDlg.show(params)
    local go = GameObject.Find("dlgdialogbox_listwithtab")
