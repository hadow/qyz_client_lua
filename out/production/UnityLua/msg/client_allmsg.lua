...
id=6556181,
ALL = 0,
DECLARE_WAR_MY_DECLARE = 1,
DECLARE_WAR_DECLARE_ME = 2,
DECLAR_WAR_NOT_DECLARE = 3,
{ name='ftype', type='int'},
...
msg.add_type('lx.gs.family.msg.roundmatch', {
name='SFamilyRoundInfo',
id=6561600,
{ name='grouptype', type='int'},
{ name='matchinfo', type='map', key='int', value='lx.gs.family.msg.roundmatch.MatchPair'},
{ name='grouprank', type='map', key='int', value='lx.gs.family.msg.roundmatch.EachGroupRank'},
{ name='familyrank', type='map', key='long', value='lx.gs.family.msg.roundmatch.FamilyMemberRankInfo'},
{ name='serverrank', type='map', key='int', value='lx.gs.family.msg.roundmatch.ServerMemberRankInfo'},
{ name='extrabonus', type='map.msg.Bonus'},
})
msg.add_type('lx.gs.map.msg', {
...
msg.add_type('lx.gs.magicbody.msg', {
name='SMagicBodyInfo',
id=6563758,
{ name='bodyinfos', type='map', key='int', value='lx.gs.magicbody.msg.BodyInfo'},
})
msg.add_type('lx.gs.friend.msg', {
...
msg.add_type('lx.gs.magicbody.msg', {
name='SStateLevelUpNotify',
id=6564016,
{ name='bodyid', type='int'},
{ name='newlevel', type='int'},
})
msg.add_type('lx.gs.pet.msg', {
name='CActiveAwakeProp',
id=6564020,
{ name='modelid', type='int'},
})
...
msg.add_type('lx.gs.activity.onlinetimebonus.msg', {
name='SActivity',
id=6564083,
{ name='id', type='int'},
{ name='nextbonusid', type='int'},
...
msg.add_type('lx.gs.rebornbiyao.msg', {
name='CDeliver',
id=6564346,
{ name='activityid', type='int'},
{ name='npcindex', type='int'},
{ name='num', type='int'},
})
msg.add_type('lx.gs.role.msg', {
name='SCurrencyAlert',
...
name='SGetAllocLog',
id=6564500,
{ name='logs', type='list', value='lx.gs.family.msg.roundmatch.AllocLog'},
})
msg.add_type('lx.gs.map.msg', {
...
id=6564918,
{ name='activityid', type='int'},
{ name='today', type='long'},
{ name='npc1', type='long'},
{ name='npc2', type='long'},
{ name='totalnpc1', type='long'},
{ name='totalnpc2', type='long'},
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.family.msg.roundmatch', {
name='CGetFamilyRoundMatchStatus',
id=6565063,
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.gemstone.msg', {
name='CUnloadGemstone',
id=6565344,
{ name='pos', type='int'},
})
msg.add_type('lx.gs.family.msg.citywar', {
...
name='SCheckTrace',
id=6566113,
{ name='totracerole', type='long'},
{ name='lasttracetime', type='long'},
{ name='todaytrace', type='int'},
{ name='isindigong', type='int'},
})
...
name='CDeclareWar',
id=6566734,
{ name='targetfamilyid', type='long'},
{ name='declare', type='byte'},
})
msg.add_type('lx.gs.family.msg.citywar', {
name='CAllocBonus',
id=6566771,
...
msg.add_type('lx.gs.lottery.msg', {
name='CLotteryRoll10',
id=6566991,
})
msg.add_type('lx.gs.magicbody.msg', {
...
{ name='bodyid', type='int'},
{ name='frompointid', type='int'},
{ name='topointid', type='int'},
})
msg.add_type('lx.gs.map.msg', {
name='COpenChrisCurEctype',
id=6567002,
})
msg.add_type('lx.gs.role.msg', {
name='SReSetWorldLevelRate',
id=6567029,
{ name='newrate', type='float'},
})
msg.add_type('lx.gs.family.msg', {
name='SFamilyWarInfo',
id=6567034,
...
msg.add_type('lx.gs.pet.msg', {
name='CActiveStarProp',
id=6567700,
{ name='modelid', type='int'},
{ name='level', type='int'},
})
msg.add_type('lx.gs.springactivity.msg', {
name='SGetRoleList',
id=6567806,
{ name='packageid', type='long'},
{ name='moneytype', type='int'},
{ name='roles', type='map', key='string', value='int'},
})
msg.add_type('lx.gs.arena.msg', {
name='CChallenge',
id=6567929,
...
{ name='eachattrs', type='map', key='int', value='lx.gs.magicbody.msg.AttrDetail'},
})
msg.add_type('lx.gs.talisman', {
name='SAddNormalExp',
id=6567985,
...
name='SSeasonEnd',
id=6568236,
{ name='familyextrabonus', type='map.msg.Bonus'},
})
msg.add_type('lx.gs.gemstone.msg', {
name='CLoadGemstone',
id=6568274,
...
msg.add_type('lx.gs.pureair.msg', {
name='CAirStarUp',
id=6569296,
{ name='airtype', type='int'},
})
msg.add_type('lx.gs.map.msg', {
...
id=6571483,
{ name='targetfamilyid', type='long'},
{ name='targetfamilyname', type='string'},
{ name='declare', type='byte'},
})
msg.add_type('lx.gs.team.msg', {
name='CAgreeJoin',
...
msg.add_type('lx.gs.map.msg', {
name='SGetMMLeftTimes',
id=6571613,
{ name='roleid2times', type='map', key='long', value='int'},
})
msg.add_type('lx.gs.map.msg', {
...
msg.add_type('lx.gs.activity.msg', {
name='SActivityParams',
id=6571965,
{ name='id', type='int'},
{ name='params', type='map', key='int', value='lx.gs.activity.msg.ListProto'},
})
msg.add_type('lx.gs.map.msg', {
...
msg.add_type('lx.gs.team.msg', {
name='SSyncNextHeroTask',
id=6572284,
{ name='nexttaskid', type='int'},
})
msg.add_type('lx.gs.talisman', {
name='SAddStarExp',
id=6572309,
...
name='SSyncAirAttrs',
id=6573280,
{ name='roleattrs', type='map', key='int', value='float'},
{ name='petattrs', type='map', key='int', value='float'},
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.family.msg', {
name='SFamilyDeclareWarInfo',
id=6575359,
{ name='isopen', type='byte'},
{ name='mydeclares', type='list', value='lx.gs.family.msg.FamilyDeclareWarInfo'},
{ name='declaremes', type='list', value='lx.gs.family.msg.FamilyDeclareWarInfo'},
})
...
msg.add_type('lx.gs.family.msg.roundmatch', {
name='SEndFamilyRoundMatchNotify',
id=6575946,
{ name='weekday', type='int'},
{ name='result', type='int'},
{ name='newcontribute', type='map', key='long', value='long'},
})
msg.add_type('lx.gs.marriage.msg', {
name='CBuyXiushu',
id=6575958,
...
{ name='newexp', type='int'},
{ name='newlevel', type='int'},
{ name='criticaltime', type='int'},
})
msg.add_type('lx.gs.lottery.msg', {
name='CLotteryScoreExchange',
id=6577715,
{ name='score', type='int'},
})
msg.add_type('lx.gs', {
...
name='SOffLineExp',
id=6578067,
{ name='offlinetime', type='int'},
{ name='offlineexp', type='long'},
})
msg.add_type('lx.gs.bag.msg', {
name='CSortBag',
id=6578091,
...
msg.add_type('lx.gs.map.msg', {
name='CGetMMLeftTimes',
id=6578169,
{ name='mmtype', type='int'},
})
msg.add_type('lx.gs.lottery.msg', {
name='SSyncScoreBonus',
id=6578200,
{ name='invalidscore', type='list', value='int'},
})
msg.add_type('lx.gs.family.msg', {
...
msg.add_type('lx.gs.map.msg', {
name='SReviveCostCount',
id=6581354,
{ name='huashencount', type='int'},
{ name='yuanbaocount', type='int'},
})
msg.add_type('lx.gs.pet.msg', {
name='SSyncPetLevel',
id=6581358,
...
name='SSyncPetProps',
id=6581663,
{ name='pets', type='map', key='int', value='lx.gs.pet.SimplePet'},
})
msg.add_type('lx.gs.mount', {
name='CBuyRide',
id=6581695,
...
msg.add_type('lx.gs.activity.keybonus.msg', {
name='SActivity',
id=6581857,
{ name='keys', type='list', value='lx.gs.activity.keybonus.msg.Key'},
})
msg.add_type('lx.gs.family.msg', {
name='CQuitFamily',
id=6581898,
...
name='SAirInfo',
id=6582121,
{ name='details', type='map', key='int', value='lx.gs.pureair.msg.AirDetail'},
})
msg.add_type('lx.gs.leaderboard.msg', {
...
msg.add_type('lx.gs.activity.monsterexp.msg', {
name='SActivity',
id=6582530,
{ name='activityid', type='int'},
{ name='remainexp', type='long'},
})
msg.add_type('lx.gs.marriage.msg', {
...
FAIL = 1,
EXCEED_MAX_TIME = 2,
HAS_RECEIVE_THIE_RED_PACKAGE = 3,
{ name='result', type='int'},
{ name='sendername', type='string'},
...
id=6582899,
{ name='airtype', type='int'},
{ name='nextawakelevel', type='int'},
{ name='luckyvalue', type='int'},
})
msg.add_type('lx.gs.family.msg', {
...
{ name='frompointid', type='int'},
{ name='topointid', type='int'},
{ name='tonormallevel', type='int'},
{ name='tobreaklevel', type='int'},
{ name='toexp', type='int'},
})
msg.add_type('lx.gs.rebornbiyao.msg', {
name='SSyncRoleScore',
...
{ name='npc2', type='long'},
{ name='today', type='long'},
{ name='dailystate', type='byte'},
{ name='finalstate', type='byte'},
})
msg.add_type('lx.gs.map.msg', {
...
{ name='totalactivepay', type='int'},
{ name='wishtimes', type='int'},
{ name='lastwishtime', type='long'},
{ name='lastwishpetid', type='long'},
{ name='iseatlunch', type='int'},
{ name='iseatdinner', type='int'},
{ name='isinspringbonus', type='int'},
{ name='springbonustype', type='int'},
{ name='receivespringbonus', type='list', value='int'},
})
msg.add_type('lx.gs.family.msg', {
...
name='SNewKey',
id=6585241,
{ name='key', type='lx.gs.activity.keybonus.msg.Key'},
})
msg.add_type('lx.gs.family.msg', {
...
{ name='familyid', type='long'},
{ name='familyname', type='string'},
{ name='declarewarfamilys', type='set', value='long'},
...
msg.add_type('map.msg', {
name='SEnterPKSafeZone',
id=6696279,
})
msg.add_type('map.msg', {
name='MGetFamilyRoundStatus',
id=6696335,
{ name='battleid', type='int'},
{ name='status1', type='map.msg.FamilyWarBattleFieldStatus'},
{ name='animal1id', type='int'},
...
msg.add_type('map.msg', {
name='XCreateFamilyRoundMatch',
id=6697865,
{ name='serverid', type='int'},
{ name='battleid', type='int'},
{ name='groupid', type='int'},
{ name='family1', type='map.msg.FamilyRoundMatchInfo'},
{ name='family2', type='map.msg.FamilyRoundMatchInfo'},
})
msg.add_type('map.msg', {
...
name='STestNetWork',
id=6702053,
{ name='datas', type='list', value='int'},
})
msg.add_type('map.msg', {
name='XCreateHuiWu',
id=6702180,
...
{ name='family1player', type='map', key='long', value='long'},
{ name='family2player', type='map', key='long', value='long'},
})
msg.add_type('map.msg', {
name='XEnterMap',
id=6702334,
...
msg.add_type('map.msg', {
name='XSetTeamFightParam',
id=6703721,
{ name='hasbonusroleids', type='set', value='long'},
})
msg.add_type('map.msg', {
name='ServicedRefs',
id=6703897,
...
msg.add_type('map.msg', {
name='SChangeMMRelation',
id=6704393,
{ name='mmrelations', type='map', key='long', value='int'},
})
msg.add_type('map.msg', {
name='SEndTeamSpeed',
id=6704438,
...
msg.add_type('map.msg', {
name='XCreateHeroTaskEctype',
id=6704841,
{ name='serverid', type='int'},
{ name='herotasktype', type='int'},
{ name='ectypeid', type='int'},
...
msg.add_type('map.msg', {
name='MEndChrisCurEctype',
id=6706470,
{ name='errcode', type='int'},
{ name='bonus', type='list', value='map.msg.Bonus'},
})
msg.add_type('map.msg', {
name='XChangeAmulet',
id=6706654,
...
id=6709318,
{ name='attackscore', type='int'},
{ name='defencescore', type='int'},
...
msg.add_type('map.msg', {
name='SChangeDeclareWarFamilys',
id=6713551,
{ name='hasdeclarewar', type='byte'},
{ name='familys', type='set', value='long'},
})
msg.add_type('map.msg', {
name='SEndTeamFight',
id=6713605,
...
id=6713705,
{ name='agentdamages', type='map', key='long', value='float'},
})
msg.add_type('map.msg', {
name='SEndHuiWu',
id=6713746,
...
msg.add_type('map.msg', {
name='MKillWorldBoss2',
id=6715151,
{ name='activityid', type='int'},
{ name='assistors', type='set', value='long'},
})
msg.add_type('map.msg', {
name='MEndHuiWu',
id=6715172,
...
{ name='serverid', type='int'},
{ name='mmtype', type='int'},
{ name='averagelevel', type='int'},
{ name='members', type='list', value='map.msg.MMMember'},
})
msg.add_type('map.msg', {
name='CReady',
id=6716137,
...
{ name='ip', type='string'},
{ name='port', type='int'},
{ name='mergeserveris', type='set', value='int'},
})
msg.add_type('gnet', {
name='PlatType',
TEST = 0,
...
msg.add_type('lx.gs.activity.msg', {
name='ListProto',
{ name='data', type='list', value='string'},
})
msg.add_type('lx.gs.activity.worldboss.msg', {
name='WorldBossInfo',
{ name='bossid', type='int'},
...
msg.add_type('lx.gs.family.msg.roundmatch', {
name='EachGroupRank',
{ name='rankinfo', type='list', value='lx.gs.family.msg.roundmatch.RoundMatchFamDetailInfo'},
})
msg.add_type('lx.gs.family.msg.roundmatch', {
name='FamilyMemberRankInfo',
{ name='roleid', type='long'},
{ name='rolename', type='string'},
{ name='level', type='int'},
{ name='viplevel', type='int'},
...
{ name='gender', type='int'},
{ name='combatpower', type='int'},
{ name='contribute', type='long'},
})
msg.add_type('lx.gs.family.msg.roundmatch', {
name='MatchPair',
{ name='family1info', type='lx.gs.family.msg.roundmatch.RoundMatchFamBaseInfo'},
{ name='family2info', type='lx.gs.family.msg.roundmatch.RoundMatchFamBaseInfo'},
{ name='result', type='int'},
})
msg.add_type('lx.gs.family.msg.roundmatch', {
name='RoundMatchFamBaseInfo',
{ name='familyname', type='string'},
{ name='familylvl', type='int'},
{ name='fid', type='long'},
})
msg.add_type('lx.gs.family.msg.roundmatch', {
name='RoundMatchFamDetailInfo',
{ name='fid', type='long'},
{ name='familyname', type='string'},
{ name='familylvl', type='int'},
{ name='win', type='int'},
...
msg.add_type('lx.gs.magicbody.msg', {
name='AttrDetail',
{ name='attr', type='map', key='int', value='float'},
})
msg.add_type('lx.gs.magicbody.msg', {
name='BodyInfo',
{ name='id', type='int'},
{ name='extraattr', type='map', key='int', value='float'},
{ name='statelevel', type='int'},
{ name='pointsinfo', type='map', key='int', value='lx.gs.magicbody.msg.PointInfo'},
{ name='curspecialpoint', type='int'},
})
msg.add_type('lx.gs.magicbody.msg', {
name='PointInfo',
{ name='id', type='int'},
{ name='normallevl', type='int'},
{ name='breaklevel', type='int'},
{ name='curexp', type='int'},
{ name='attr', type='map', key='int', value='float'},
})
msg.add_type('lx.gs.mail.msg', {
name='Mail',
...
{ name='normallevl', type='int'},
{ name='starlevel', type='int'},
{ name='laylevel', type='int'},
{ name='normalluckyvalue', type='int'},
{ name='awakeluckyvalue', type='int'},
{ name='attr', type='map', key='int', value='float'},
})
msg.add_type('lx.gs.rank.msg', {
name='FamilyRankInfo',
...
msg.add_type('map.msg', {
name='BeHealResult',
{ name='heal', type='float'},
})
msg.add_type('map.msg', {
name='Bonus',
{ name='bindtype', type='int'},
{ name='items', type='map', key='int', value='long'},
})
msg.add_type('map.msg', {
name='EffectInfo',
{ name='id', type='int'},
...
{ name='skills', type='map', key='int', value='int'},
{ name='attrs', type='map', key='int', value='float'},
{ name='transformeffectid', type='int'},
{ name='transformremaintime', type='float'},
})
msg.add_type('map.msg', {
name='HealResult',
{ name='defencerid', type='long'},
